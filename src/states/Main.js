...
class Main extends Phaser.State {
	...
	render() {
		// this.game.debug.spriteInfo(this.playerObject, 32, 232);
		// this.game.debug.spriteInfo(	this.tree, 32, 132);
		// this.game.debug.cameraInfo(this.game.camera, 32, 32);
		// this.game.debug.spriteCoords(this.tree, 32, 500);

		// this.game.debug.body(this.wormObject);
